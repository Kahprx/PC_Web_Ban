...
router.get('/warranty/:orderCode', getWarrantyByOrderCode);
...
router.get('/my/items', requireAuth, getMyPurchasedItems);
router.get('/my/:orderId', requireAuth, getMyOrderDetail);
